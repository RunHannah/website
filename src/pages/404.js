  ...
  <Layout>
    <Fade duration={1000} delay={500}>
      <div className="flex flex-col justify-center items-center h-screen">
        ...
        <Link
          className="btn-text text-center text-xs py-3 px-4 mb-8 sm:text-sm md:w-32 md:text-base md:py-4 lg:text-lg lg:px-5 border-solid border rounded font-bold"
          to="/"
        >
          Go Home
        </Link>
